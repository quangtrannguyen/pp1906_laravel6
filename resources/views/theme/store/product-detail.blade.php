								...
								<div class="col-md-5">
									<div class="product-entry">
										...
										<div class="thumb-nail">
											<a href="#" class="thumb-img" style="background-image: url(theme/images/item-11.jpg);"></a>
											<a href="#" class="thumb-img" style="background-image: url(theme/images/item-12.jpg);"></a>
											<a href="#" class="thumb-img" style="background-image: url(theme/images/item-16.jpg);"></a>
										</div>
									</div>
								</div>
								<div class="col-md-7">
								   ...
								   <div id="review" class="tab-pane fade">
								   	<div class="row">
								   		<div class="col-md-7">
								   			<h3>23 Reviews</h3>
								   			<div class="review">
										   		<div class="user-img" style="background-image: url(theme/images/person1.jpg)"></div>
										   		<div class="desc">
										   			<h4>
										   	...
										   	<div class="review">
										   		<div class="user-img" style="background-image: url(theme/images/person2.jpg)"></div>
										   		<div class="desc">
										   			<h4>
										   				<span class="text-left">Jacob Webb</span>
										   				<span class="text-right">14 March 2018</span>
										   	...
										   	<div class="review">
										   		<div class="user-img" style="background-image: url(theme/images/person3.jpg)"></div>
										   		<div class="desc">
										   			<h4>
										   				<span class="text-left">Jacob Webb</span>
										   				<span class="text-right">14 March 2018</span>
